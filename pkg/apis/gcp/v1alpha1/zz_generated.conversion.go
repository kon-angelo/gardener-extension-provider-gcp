...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ImmutabilityConfig)(nil), (*gcp.ImmutabilityConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ImmutabilityConfig_To_gcp_ImmutabilityConfig(a.(*ImmutabilityConfig), b.(*gcp.ImmutabilityConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*gcp.ImmutabilityConfig)(nil), (*ImmutabilityConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_gcp_ImmutabilityConfig_To_v1alpha1_ImmutabilityConfig(a.(*gcp.ImmutabilityConfig), b.(*ImmutabilityConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_BackupBucketConfig_To_gcp_BackupBucketConfig(in *BackupBucketConfig, out *gcp.BackupBucketConfig, s conversion.Scope) error {
	out.Immutability = (*gcp.ImmutabilityConfig)(unsafe.Pointer(in.Immutability))
	return nil
}
...
func autoConvert_gcp_BackupBucketConfig_To_v1alpha1_BackupBucketConfig(in *gcp.BackupBucketConfig, out *BackupBucketConfig, s conversion.Scope) error {
	out.Immutability = (*ImmutabilityConfig)(unsafe.Pointer(in.Immutability))
	return nil
}
...
func autoConvert_v1alpha1_ImmutabilityConfig_To_gcp_ImmutabilityConfig(in *ImmutabilityConfig, out *gcp.ImmutabilityConfig, s conversion.Scope) error {
...
// Convert_v1alpha1_ImmutabilityConfig_To_gcp_ImmutabilityConfig is an autogenerated conversion function.
func Convert_v1alpha1_ImmutabilityConfig_To_gcp_ImmutabilityConfig(in *ImmutabilityConfig, out *gcp.ImmutabilityConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_ImmutabilityConfig_To_gcp_ImmutabilityConfig(in, out, s)
}

func autoConvert_gcp_ImmutabilityConfig_To_v1alpha1_ImmutabilityConfig(in *gcp.ImmutabilityConfig, out *ImmutabilityConfig, s conversion.Scope) error {
	out.RetentionType = in.RetentionType
	out.RetentionPeriod = in.RetentionPeriod
	out.Locked = in.Locked
	return nil
...
// Convert_gcp_ImmutabilityConfig_To_v1alpha1_ImmutabilityConfig is an autogenerated conversion function.
func Convert_gcp_ImmutabilityConfig_To_v1alpha1_ImmutabilityConfig(in *gcp.ImmutabilityConfig, out *ImmutabilityConfig, s conversion.Scope) error {
	return autoConvert_gcp_ImmutabilityConfig_To_v1alpha1_ImmutabilityConfig(in, out, s)
}
